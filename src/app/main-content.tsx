        ...
        <div className="h-screen w-screen overflow-hidden bg-neutral-50 dark:bg-neutral-950">
          <ResizablePanelGroup direction="horizontal" className="h-full">
            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white dark:bg-neutral-900">
                {/* Top Bar */}
                <div className="h-14 border-b border-neutral-200/60 dark:border-neutral-700/60 px-6 flex items-center justify-between bg-neutral-50/50 dark:bg-neutral-900">
                  <Tabs
                    value={activeView}
                    onValueChange={(v) =>
